...
class ContainerManager:
    ...
    def build_image(self, project_path: str, project_name: str, dockerfile_path: str, 
                   custom_commands: List[str] = None) -> Dict[str, Any]:
        """
    ...
    def run_container(self, project_name: str, ports: Dict[str, int] = None, 
                     environment: Dict[str, str] = None, command: str = None) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            container_name = f"{project_name}-{int(time.time())}-{str(uuid.uuid4())[:8]}"
