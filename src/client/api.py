...
class RacerAPIClient:
    ...
    def _make_request(self, method: str, endpoint: str, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            raise RacerAPIError(f"Request to {url} timed out after {self.timeout} seconds")
        except requests.exceptions.HTTPError as e:
            raise RacerAPIError(f"HTTP error {e.response.status_code}: {e.response.text}")
